(() => {
    ...
    (function() {
        ...
        var Constructor = function(element) {
            ...
            if (document.getElementById("TimePickStyleSheet") == null) MakeStyle();
            ...
            for (var i = 0; i < globalvar.elemets.length; i++) {
                ...
                } else globalvar.elemets[i].setAttribute("value", "00:00:00");
            }
            let timepickpopupbtn = document.getElementsByClassName("TimePick_ICON");
            for (let i = 0; i < timepickpopupbtn.length; i++) timepickpopupbtn[i].onclick = function() {
            ...
            document.onclick = function(e) {
                if (e.target.id == "TimePickBackgroundOverlay") {
                    ...
                    for (let i = 0; i < TimePick_POPUP.length; i++) TimePick_POPUP[i].style.display = "none";
                }
            };
            let adjustbtn = document.getElementsByClassName("adjustbtn");
            for (let i = 0; i < adjustbtn.length; i++) adjustbtn[i].onclick = function() {
                ...
                if (curr_hour != "00") globalvar.set_hour[data.id] = parseInt(curr_hour);
                if (curr_minute != "00") globalvar.set_minute[data.id] = parseInt(curr_minute);
                if (curr_second != "00") globalvar.set_second[data.id] = parseInt(curr_second);
                ...
                let hrview = globalvar.set_hour[data.id] == void 0 ? "00" : globalvar.set_hour[data.id] < 10 ? "0" + globalvar.set_hour[data.id] : globalvar.set_hour[data.id];
                let mnview = globalvar.set_minute[data.id] == void 0 ? "00" : globalvar.set_minute[data.id] < 10 ? "0" + globalvar.set_minute[data.id] : globalvar.set_minute[data.id];
                let snview = globalvar.set_second[data.id] == void 0 ? "00" : globalvar.set_second[data.id] < 10 ? "0" + globalvar.set_second[data.id] : globalvar.set_second[data.id];
